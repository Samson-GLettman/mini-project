...
couriers_list = [{'Name':'Thomas', 'Phone Number': '0800 00 1066'},{'Name':'Dick', 'Phone Number': '0800 00 1066'},{'Name':'Andy','Phone Number': '0800 00 1066'},{'Name':'Harry','Phone Number':'0800 00 1066'},{'Name':'adam','Phone Number':'0800 00 1066'}]
orders = [{'Order ID': '1', 'Customer Name': 'Vish', 'customer Address': 'london', 'Customer Phone': 'none of your busssiness', 'Courier': 'andy', 'Status': 'pending'},{'Order ID': '2', 'Customer Name': 'elshaday', 'customer Address': 'london', 'Customer Phone': 'not telling', 'Courier': 'Tom', 'Status': 'pending'},{'Order ID': '3', 'Customer Name': 'samson', 'customer Address': 'london', 'Customer Phone': 'lol', 'Courier': 'Harry', 'Status': 'pending'}]
...
def read_couriers_list_to_csv():
    with open("Couriers_List.csv", mode='r',newline='') as file: 
        csv_file = csv.DictReader(file) 
        for row in csv_file: 
            print(row)
...
def update_product(product_list):
    ...
    for key,value in product_list[answer].items():
        print(f"{key}:{value}")
